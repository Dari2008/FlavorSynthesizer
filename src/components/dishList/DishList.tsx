...
function DishListItem({ dish, currentPlayingUUID, playDish, progressChangeRef }: { dish: Dish | LocalDish, currentPlayingUUID: string | null, playDish: (dish: Dish | LocalDish) => void; progressChangeRef: React.RefObject<(progress: number) => void>; }) {
