...
export type GameState = "loading" | "mainMenu" | "dishList" | "restaurant" | "customFlavors" | "openShared" | "createDish-mainFlavor" | "createDish-create" | "createDish-create-viewonly" | "createDish-share";